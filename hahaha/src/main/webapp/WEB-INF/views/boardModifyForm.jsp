...
<div class="container">
    ...
    <form id="modifyForm" action="${pageContext.request.contextPath}/board/BoardModifyAction" method="post">
        ...
        <div class="form-group">
            ...
            <input class="form-control" value="${board.board_title}" name="board_title" id="boardTitle" type="text"/>
        </div>
        <div class="form-group">boardContent :
            <textarea class="form-control" id="boardContent" name="board_content" rows="5" cols="50">${board.board_content}</textarea>
        </div>
        <div>
